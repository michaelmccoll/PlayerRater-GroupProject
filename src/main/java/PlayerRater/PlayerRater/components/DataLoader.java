...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args){
        ...
        Team team2 = new Team("Gorgie F.C.","Murrayfield","Edinburgh Amateurs","Maroon","White",null);
        teamRepository.save(team2);
        Team team3 = new Team("Queensferry Park Rangers","Forth Stadium","Edinburgh Amateurs","Blue","Black",null);
        teamRepository.save(team3);
        Team team4 = new Team("Stockbridge United","Raeburn","Edinburgh Amateurs","Yellow","Pink",null);
        teamRepository.save(team4);
        Team team5 = new Team("Portobello Pirates","Joppa","Edinburgh Amateurs","Red","Black",null);
